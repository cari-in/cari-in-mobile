...
class banglitreckking : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val resultTextView = findViewById<TextView>(R.id.recomendationbanglitreckking)
    ...
    fun openMapsLink(view: View) {
        val mapsUri = Uri.parse("https://goo.gl/maps/9es239DECHbZ6sCT8")
