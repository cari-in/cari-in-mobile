...
class resultdenpasar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_resultdenpasar)
        ...
        val resultTextView = findViewById<TextView>(R.id.recomendationdenpasar)
