package com.example.cariinapp.result.button.bangli
...
class banglispot : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_banglispot)
        ...
        val resultTextView = findViewById<TextView>(R.id.recomendationbanglispot)
    ...
    fun openGoogleMapsLink(view: View) {
        val mapsUri = Uri.parse("https://goo.gl/maps/oNZFvSPpvjZMcDY68")
