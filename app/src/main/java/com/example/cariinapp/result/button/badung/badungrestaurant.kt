...
class badungrestaurant : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_badungrestaurant)
        ...
        val resultTextView = findViewById<TextView>(R.id.recomendationbadungres)
    ...
    fun openGoogleMaps(view: View) {
        val mapsUri = Uri.parse("https://goo.gl/maps/K4tS3DPwYj6ZiNzN7")
