package com.example.cariinapp.result.denpasar
...
class resultdenpasarswim : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_resultdenpasarswim)
        ...
        val resultTextView = findViewById<TextView>(R.id.recomendationdenpasarswim)
    ...
    fun openGoogleMaps(view: View) {
        val gmmIntentUri = Uri.parse("https://goo.gl/maps/7KhWpUS4DYskFKHf8")
