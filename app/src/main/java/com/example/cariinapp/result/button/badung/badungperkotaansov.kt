...
class badungperkotaansov : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_badungperkotaan)
        ...
        val resultTextView = findViewById<TextView>(R.id.recomendationbadungurbansov)
